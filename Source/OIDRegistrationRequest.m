...
/*! @brief Key used to encode the @c initialAccessToken property for @c NSSecureCoding
 */
static NSString *const kInitialAccessToken = @"initialAccessToken";
...
@synthesize initialAccessToken = _initialAccessToken;
...
- (NSURLRequest *)URLRequest {
    ...
    static NSString * kHTTPAuthorizationHeaderValue = @"bearer ";
    
    if (_initialAccessToken) {
        kHTTPAuthorizationHeaderValue = [kHTTPAuthorizationHeaderValue stringByAppendingString:_initialAccessToken];
    }
    ...
    [URLRequest setValue:kHTTPAuthorizationHeaderValue forHTTPHeaderField:kHTTPAuthorizationHeaderKey];
